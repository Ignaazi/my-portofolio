...
import BestProjectPage from "./page.project"; // Import komponen Best Project baru
...
export default function HomePage({ isDarkMode }: HomePageProps) {
  ...
  return (
    <div className="w-full flex flex-col gap-10">
      ...
      >
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-3 shrink-0">
            <a href="#" className="w-8 h-8 rounded-lg bg-[#0077B5] flex items-center justify-center text-white hover:scale-110 transition-transform">
              <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
            </a>
            <a href="#" className="w-8 h-8 rounded-lg bg-[#24292E] flex items-center justify-center text-white hover:scale-110 transition-transform">
            ...
            <a href="#" className="w-8 h-8 rounded-lg bg-gradient-to-tr from-[#FFB200] via-[#D52685] to-[#4F5BD5] flex items-center justify-center text-white hover:scale-110 transition-transform">
            ...
            <a href="#" className="w-8 h-8 rounded-lg bg-black flex items-center justify-center text-white hover:scale-110 transition-transform">
        ...
        <div className="mt-5">
          <a 
            href="/assets/cv_muhammad_ignazi.pdf"
            download="CV_Muhammad_Ignazi.pdf"
            className="inline-flex items-center gap-2 bg-orange-500 hover:bg-orange-600 active:scale-95 text-white font-extrabold text-xs px-5 py-2.5 rounded-xl shadow-xs transition-all duration-200"
          >
      ...
      {/* ==================== 3. HIRE ME SECTION ==================== */}
      <HireMePage isDarkMode={isDarkMode} />

      {/* ==================== 4. BEST PROJECT SECTION ==================== */}
      <BestProjectPage isDarkMode={isDarkMode} />
    </div>
  );
}